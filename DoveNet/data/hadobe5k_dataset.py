...
class HAdobe5kDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        if opt.isTrain==True:
            ...
            self.trainfile = opt.dataset_root+'HAdobe5k_train.txt' #修改点1，替换HCOCO_train.txt
            with open(self.trainfile,'r') as f:
                    for line in f.readlines():
                        self.image_paths.append(os.path.join(opt.dataset_root, 'composite_images', line.rstrip())) #修改点2，增加composite_images
        elif opt.isTrain==False:
            print('loading test file')
            self.trainfile = opt.dataset_root+'HAdobe5k_test.txt' #修改点3， 替换HCOCO_test
            with open(self.trainfile,'r') as f:
                    for line in f.readlines():
                        self.image_paths.append(os.path.join(opt.dataset_root, 'composite_images', line.rstrip())) #修改点4，
